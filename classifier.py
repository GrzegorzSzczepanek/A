...
CRITICAL: <section> elements CANNOT be nested. Do NOT put a <section> inside another <section>. All subsections at the same or different levels must be SIBLINGS inside the body (<conbody>, <taskbody>, or <refbody>). When you see a new [SUBSECTION_TITLE], close the previous <section> and start a new one.
